<template>
<div class="linkPage">
  <InnerLink text="Home" link="/" color="#2196f3" />
  ...
  <div v-if="edit">
    ...
    <div v-if="selectedLink">
      <h1>Item Selected:</h1>
      <EditLink :selectedLink="selectedLink" section="school" @reset="reset" />
    </div>

    <p></p>
    <InnerLink text="Create New Link" link="/createLink" color="#2196f3" />
...
export default {
  ...
  methods: {
    async getLinks() {
      try {
        let list = await axios.get("/api/schoollinks");
